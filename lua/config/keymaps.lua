...
-- for CodeCompanion
vim.api.nvim_set_keymap("n", "<leader>az", "<cmd>CodeCompanionActions<cr>", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "<leader>az", "<cmd>CodeCompanionActions<cr>", { noremap = true, silent = true })
